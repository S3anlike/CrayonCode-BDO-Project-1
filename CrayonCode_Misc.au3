...
Global $oldVersion = IniRead("config\updater.ini","Version","MVersion","NotFound")
...
Else
    $newVersion = IniRead (@ScriptDir & "\config\version.ini","Version","MVersion","") ;reads the new version out of version.ini
    ...
    Else
        ...
        ElseIf $msg = 6 Then ;OK was pressed
            ...
            IniWrite("config\updater.ini","Version","MVersion",$NewVersion) ;updates update.ini with the new version
            InetClose($dlhandle)
