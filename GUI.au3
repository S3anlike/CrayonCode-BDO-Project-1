...
$CBReserve = GUICtrlCreateCheckbox("Enable reserving slots for relics, slots to reserve (if enabled):", 160, 174, 300, 17)
$ISlotsReserved = GUICtrlCreateInput("10", 470, 174, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_NUMBER))
GUICtrlCreateGroup("", -99, -99, 1, 1)
