...
$CBLogFile = GUICtrlCreateCheckbox(_MultiLang_GetText("log"), 160, 128, 137, 17)
...
$Telegram_Token = GUICtrlCreateInput("420543843:AAFhUs2A4LXwdRzhTr3HO9mrJKbV5T3mCpc", 83, 37, 301, 21)
