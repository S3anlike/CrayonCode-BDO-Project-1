...
Global $oldVersion = IniRead("updater.ini","Version","FVersion","NotFound")
...
Else
    $newVersion = IniRead (@ScriptDir & "\version.ini","Version","FVersion","") ;reads the new version out of version.ini
    ...
    Else
        ...
        ElseIf $msg = 6 Then ;OK was pressed
            $downloadLink = IniRead(@ScriptDir & "\version.ini","Version","Fdownload","NotFound")
